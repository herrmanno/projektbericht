...
\usepackage{fancyhdr}
\pagestyle{fancy}
\rhead{\includegraphics[width=1cm]{images/eclipse1}}
...
\titlehead{\centering\includegraphics[width=6cm]{images/eclipse1}}
\title{
