...
\begin{equation} \label{eq:k_workflow_jahr}
	E_{jahr} = T_{\Delta jahr} *  \frac{30 \euro}{h} = 636 \euro
\end{equation}
...
\begin{equation} \label{eq:amort}
	T_{amortisation} = \frac{K_{ges}}{E_{jahr}} = \frac{1120 \euro}{636 \euro / 1a} = 1,76a
\end{equation}
...
Die wird mit Hilfe der CSS3 Spezifikation
...
\begin{table}[H]
	...
	\begin{tabular}{lccc}
		...
		\rowcolor{gray!15}
		Anwenderschulungs & 2h & \timeEinfuehrung & \timeEinfuehrungDiff \\\hline    	    	    
